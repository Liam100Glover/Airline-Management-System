...
public class loginpage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/airlinemanagement/backgroundlogin.png"))); // NOI18N
    ...
    String un = user.getText();  // Assuming 'user' is the JTextField for username
    String pw = pass.getText();  // Assuming 'pass' is the JTextField for password
    ...
    while (rs.next()) {
        ...
        isValidUser = true;
        UserSession.getInstance(username); // Store the username in the session
        
        // Check username directly to dispatch to different dashboards
        if ("admin".equals(username)) {
            new dashboard().setVisible(true);
        } else if ("passenger".equals(username)) {
            new passdashboard().setVisible(true);
        } else if ("passenger2".equals(username)) {
            new passdashboard().setVisible(true);
        }
            ...
            JOptionPane.showMessageDialog(this, "User role not recognized!");
            isValidUser = false;  // Consider the login not valid if the username is not one of the expected
        }
